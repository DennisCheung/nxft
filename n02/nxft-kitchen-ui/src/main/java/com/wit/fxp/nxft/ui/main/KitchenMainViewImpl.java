...
@UIScope
@SpringView(name = KitchenMainView.NAME, ui = KitchenUI.class)
public class KitchenMainViewImpl extends Panel implements KitchenMainView {
    ...
    public void enter(ViewChangeEvent event) {
        ...
        WorkspaceUtils.getMainWorkspace(getUI()).openPage(DefaultPageContext.builder()
                ._viewName__________(KitchenViewName.KITCHEN_MAIN_VIEW_NAME)
                ._key_______________("")
