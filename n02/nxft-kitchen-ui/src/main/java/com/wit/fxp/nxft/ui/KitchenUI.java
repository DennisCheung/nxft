...
@Title("健康助餐服务系统--厨房工作站")
@SpringUI(path = "/kitchen")
@Push(transport = Transport.LONG_POLLING)
@Theme("tests-valo-facebook")
@Widgetset("com.wit.fxp.widgetset.AppWidgetSet")
@PreserveOnRefresh
public class KitchenUI extends UI implements HasEventBus, HasWorkspacePresenter, HasUserSession {
    ...
    @Autowired private NxftKitchenViewChangeListener viewChangeListener;
    ...
    protected void init(VaadinRequest request) {
        ...
        // 子系统登录
        userSessionCreator.createUserSession(DBC.子系统.配餐工作站.value());
    ...
    private void saveCookie() {
        Cookie cookie = new Cookie(FxpConstants.URL_COOKIE_NAME, "/v/kitchen");
        cookie.setMaxAge(-1);
        cookie.setPath("/");
