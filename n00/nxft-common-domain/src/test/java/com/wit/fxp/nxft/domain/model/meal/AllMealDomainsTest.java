...
public class AllMealDomainsTest {
    ...
    @Autowired
    private com.wit.fxp.nxft.domain.model.meal.checker.MealCheckerRepo repo;

    // 每天菜谱
    @Test
    public void testMealScheday() {
        this.repo.findMealScheday();
    }

    // 菜谱安排单
    @Test
    public void testMealSchenote() {
        this.repo.findMealSchenote();
    }

    // 套餐字典
    @Test
    public void testMealSet() {
     ...
     */
    @Configuration
    @Import(com.wit.fxp.nxft.domain.model.meal.checker.HibernateMealCheckerRepoImpl.class)
    @EnableTransactionManagement
    static class TestConfig {

        private static final String DB_USERNAME = "sa";
        private static final String DB_PASSWORD = "";
        private static final String DB_URL = "jdbc:h2:mem:nxft-meal;MODE=Oracle;DB_CLOSE_DELAY=-1";
