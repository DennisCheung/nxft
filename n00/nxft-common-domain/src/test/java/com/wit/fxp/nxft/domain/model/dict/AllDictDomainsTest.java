...
public class AllDictDomainsTest {
    ...
    @Autowired
    private com.wit.fxp.nxft.domain.model.dict.checker.DictCheckerRepo repo;

    // 工作圈厨房签约
    @Test
    public void testCircleKitchen() {
        this.repo.findCircleKitchen();
    }

    // 饮食偏好
    @Test
    public void testFoodLove() {
        this.repo.findFoodLove();
    }

    // 食物禁忌
    @Test
    public void testFoodProhibit() {
    ...
    // 配餐对象补贴标准设置
    @Test
    public void testSubjectAssistance() {
     ...
     */
    @Configuration
    @Import(com.wit.fxp.nxft.domain.model.dict.checker.HibernateDictCheckerRepoImpl.class)
    @EnableTransactionManagement
    static class TestConfig {

        private static final String DB_USERNAME = "sa";
        private static final String DB_PASSWORD = "";
        private static final String DB_URL = "jdbc:h2:mem:nxft-dict;MODE=Oracle;DB_CLOSE_DELAY=-1";
        ...
        @PostConstruct
        void init() {
            String dbScriptFullPath = DbScriptManager.getDbScriptFullPath(AllDictDomainsTest.class);
