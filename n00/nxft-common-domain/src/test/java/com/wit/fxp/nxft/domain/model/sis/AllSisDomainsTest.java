...
import com.wit.fxp.nxft.domain.model.dict.AllDictDomainsTest;
...
public class AllSisDomainsTest {
    ...
    @Autowired
    private com.wit.fxp.nxft.domain.model.sis.checker.SisCheckerRepo repo;

    // 配餐服务资源
    @Test
    public void testSisServiceResource() {
     ...
     */
    @Configuration
    @Import(com.wit.fxp.nxft.domain.model.sis.checker.HibernateSisCheckerRepoImpl.class)
    @EnableTransactionManagement
    static class TestConfig {

        private static final String DB_USERNAME = "sa";
        private static final String DB_PASSWORD = "";
        private static final String DB_URL = "jdbc:h2:mem:nxft-sis;MODE=Oracle;DB_CLOSE_DELAY=-1";
