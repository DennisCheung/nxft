...
/**
 * 用户进入随访系统时自动创建其{@link com.wit.fxp.sc.ui.session.ScUserContext 会话}。
 *
 * @author zqx
 *
 */
@UIScope
@SpringComponent
public class NxftViewChangeListener implements ViewChangeListener {
    ...
    @Autowired
    public NxftViewChangeListener(ApplicationContext applicationContext) {
