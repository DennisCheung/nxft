...
@PreserveOnRefresh
public class NxftUI extends UI implements HasEventBus, HasWorkspacePresenter, HasUserSession {
    ...
    @Autowired private NxftViewChangeListener viewChangeListener;
    ...
    protected void init(VaadinRequest request) {
        ...
        // 子系统登录:默认上次登陆地点，如果一次都没有登陆，随机取第一个登陆。
        userSessionCreator.createUserSession(DBC.子系统.助餐点工作站.value());
    ...
    private void saveCookie() {
        Cookie cookie = new Cookie(FxpConstants.URL_COOKIE_NAME, "/v/nxft");
        cookie.setMaxAge(-1);
        cookie.setPath("/");
