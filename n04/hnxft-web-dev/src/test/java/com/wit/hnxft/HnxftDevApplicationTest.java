...
@SpringBootTest(
        classes = {HnxftDevApplicationTest.MyConfiguration.class, HnxftDevApplication.class},
        properties = "spring.profiles.active=dev,indep,test")
public class HnxftDevApplicationTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(HnxftDevApplicationTest.class);
