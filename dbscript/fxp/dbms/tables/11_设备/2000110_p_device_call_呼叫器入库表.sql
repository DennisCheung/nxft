...
-- +-----------------------------+--------------+-----------+
   ...
   -- 主键、唯一键
   --
   constraint pk_p_device_call primary key (fdevice_id),
   constraint uk_p_device_call unique (fdevice_sn,fcompany_id,fdevice_model_id)
);
