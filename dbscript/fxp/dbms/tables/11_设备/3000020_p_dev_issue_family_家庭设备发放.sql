...
--
--
-- Drop Table fxp.p_dev_issue_family;
...
-- +-----------------------------+--------------+-----------+
   ...
   -- 主键、唯一键
   --
   constraint pk_p_dev_issue_family primary key (fissue_id),
   constraint uk_p_dev_issue_family_dev unique (fdevice_id),
   constraint uk_p_dev_issue_family_sn unique (fdevice_type_id,fcompany_id,fdevice_model_id,fdevice_sn)
);
