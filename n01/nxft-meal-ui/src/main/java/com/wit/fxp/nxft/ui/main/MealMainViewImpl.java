...
@UIScope
@SpringView(name = MealMainView.NAME, ui = MealUI.class)
public class MealMainViewImpl extends Panel implements MealMainView {
    ...
    public void enter(ViewChangeEvent event) {
        ...
        WorkspaceUtils.getMainWorkspace(getUI()).openPage(DefaultPageContext.builder()
                ._viewName__________(MealViewName.MEAL_MAIN_VIEW_NAME)
                ._key_______________("")
