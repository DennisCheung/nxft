...
import com.wit.fxp.nxft.ui.MealUI;

@UIScope
@SpringView(name = MealToolbarView.NAME, ui = MealUI.class)
public class MealToolbarViewImpl extends CustomComponent implements MealToolbarView, Serializable {
    ...
    private final Label projectTitle = new Label("健康助餐服务系统--坐席工作站");
    ...
    @Override
    public void initView(MealToolbarPresenter scToolbarPresenter) {
    ...
    @Override
    public void initMenu(List<MealMenuItemViewModel> vs) {
