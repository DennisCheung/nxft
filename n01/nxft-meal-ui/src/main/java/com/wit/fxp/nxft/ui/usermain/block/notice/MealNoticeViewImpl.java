...
@PrototypeScope
@SpringView(name = MealNoticeView.NAME)
public class MealNoticeViewImpl extends CustomComponent implements MealNoticeView, View, Serializable {
